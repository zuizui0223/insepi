...
This script changes text placement/labels only. It does not read or alter
scientific inputs and never touches V7 modules or outputs. After polishing, it
refreshes the figure manifest hashes so the uploaded package remains consistent.
"""
...
FIG2_NEW = '\n'.join((
    '<text x="200.0" y="694.0" font-family="Arial, Helvetica, sans-serif" font-size="16" font-weight="400" fill="#202124" text-anchor="start">targeted policies trade event recovery against hidden-error recovery and sampling distortion;</text>',
    '<text x="200.0" y="718.0" font-family="Arial, Helvetica, sans-serif" font-size="16" font-weight="400" fill="#202124" text-anchor="start">fixed disagreement is not a free improvement.</text>',
))
FIG2_OLD_OR = '<text x="691.7" y="588.0" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="400" fill="#202124" text-anchor="middle">or risky</text>'
FIG2_NEW_OR = '<text x="691.7" y="588.0" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="400" fill="#202124" text-anchor="middle">candidate OR risky</text>'
FIG2_OLD_AND = '<text x="855.0" y="588.0" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="400" fill="#202124" text-anchor="middle">and risky</text>'
FIG2_NEW_AND = '<text x="855.0" y="588.0" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="400" fill="#202124" text-anchor="middle">candidate AND risky</text>'
...
def polish(output_dir: Path) -> None:
    ...
    replace_once(fig2, FIG2_OLD_OR, FIG2_NEW_OR)
    replace_once(fig2, FIG2_OLD_AND, FIG2_NEW_AND)
